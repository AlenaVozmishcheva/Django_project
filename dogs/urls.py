...
from dogs.views import index_view, BreedsListView, DogBreedListView, DogListView, DogCreateView, \
    DogDetailView, DogUpdateView, DogDeleteView, DogDeactivatedListView, dog_toggle_activity, BreedDogSearchListView, DogSearchListView, BreedSearchListView
